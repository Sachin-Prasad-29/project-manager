<template>
    <div>
        <h3 class="subheading grey--text my-3">DashBoard Page</h3>
            ...
            projects: [
                {
                    ...
                    due: '1 Jan 2023',
                    status: 'ongoing',
                    content: 'This is the  short description about the working of ther project which we will be making',
                },
                {
                    title: 'Workshop Application',
                    person: 'Sameer and Nitish',
                    due: '10 Jan 2023',
                    status: 'completed',
                    content: 'This is the  short description about the working of ther project which we will be making',
                },
